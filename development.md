...
## Docker Compose in `localhost.trojo.com`
...
```dotenv
DOMAIN=localhost.trojo.com
```

That will be used by the Docker Compose files to configure the base domain for the services.

Traefik will use this to transmit traffic at `api.localhost.trojo.com` to the backend, and traffic at `dashboard.localhost.trojo.com` to the frontend.

The domain `localhost.trojo.com` is a special domain that is configured (with all its subdomains) to point to `127.0.0.1`. This way you can use that for your local development.
...
### Development URLs with `localhost.trojo.com` Configured

Development URLs, for local development.

Frontend: <http://dashboard.localhost.trojo.com>

Backend: <http://api.localhost.trojo.com>

Automatic Interactive Docs (Swagger UI): <http://api.localhost.trojo.com/docs>

Automatic Alternative Docs (ReDoc): <http://api.localhost.trojo.com/redoc>

Adminer: <http://localhost.trojo.com:8080>

Traefik UI: <http://localhost.trojo.com:8090>

MailCatcher: <http://localhost.trojo.com:1080>
